...
if __name__=="__main__":
    ...
    pccn_1_pls,pccn_2_pls,pccn_3_pls=p.get('pccn_1_pls'),p.get('pccn_2_pls'),p.get('pccn_3_pls');
    zs_1,zs_2,zs_3=pccn_1_pls[0],pccn_2_pls[0],pccn_3_pls[0];
    p=get_three_section_responsibility(one,zs_1,two,zs_2,three,zs_3);

    # print(p.get('pccn_1_pls')[0])
    
    pccn_1_resp=p.get('pccn_1_resp_mean');
    dc_mean,ds_mean=pccn_1_resp.get('dc_mean'),pccn_1_resp.get('ds_mean')
    print(dc_mean,ds_mean)
    pccn_2_resp=p.get('pccn_2_resp_mean');
    dc_mean,ds_mean=pccn_2_resp.get('dc_mean'),pccn_2_resp.get('ds_mean')
    print(dc_mean,ds_mean)
    pccn_3_resp=p.get('pccn_3_resp_mean');
    dc_mean,ds_mean=pccn_3_resp.get('dc_mean'),pccn_3_resp.get('ds_mean')
    print(dc_mean,ds_mean)
